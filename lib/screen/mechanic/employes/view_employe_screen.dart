...
import 'package:flutter_mechanic_app_fyp/screen/mechanic/employes/add_employe_screen.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => AddEmployeeScreen(name: '', status: 'add', docId: '', email: '', phone: '',)),
          );
        },
      ...
      appBar: AppBar(
        ...
        backgroundColor: primaryColor,
        centerTitle: true,
        title: Text('Employees',style: TextStyle(color: Colors.white,fontSize: 14),),
      ),

      body:  StreamBuilder(
        stream: FirebaseFirestore.instance.collection("Employee").where('mechanicId',isEqualTo: _auth.currentUser!.uid.toString()).snapshots(),
