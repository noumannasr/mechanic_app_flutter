...
import 'package:flutter_mechanic_app_fyp/splash/splash_screen.dart';
import 'dart:io';
...
void main() async {
  ...
  if (Firebase.apps.length == 0) {
    ...
    if (Platform.isIOS) {
      ...
      await Firebase.initializeApp(
          options: FirebaseOptions(apiKey: 'AIzaSyBq1tSoGUm9RG0eTPoLGIjwA-YgL9vIWtg',
            appId: '1:438899273342:android:bc40e4b0c696e306c0322f',
            messagingSenderId: '438899273342',
            projectId: 'flutter-mechanic-app',
            storageBucket:  "flutter-mechanic-app.appspot.com",
          )
      );
    }
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      userType == 'Mechanic' ? MechanicHomeScreen() :
